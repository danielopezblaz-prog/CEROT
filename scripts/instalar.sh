...
if [ -z "${SALTAR_ENV:-}" ]; then
  ...
  # raro de una contraseña rompa el fichero.
  {
    ...
    printf "# Envío de correo: opcional, para «he olvidado mi contraseña».\n"
    printf "# Se rellena desde el README, apartado «Recuperar la contraseña».\n"
    printf "CORREO_PROVEEDOR=''\n"
    printf "CORREO_CLAVE=''\n"
    printf "CORREO_REMITENTE=''\n"
    printf "CORREO_SERVIDOR=''\n"
    printf "CORREO_PUERTO='587'\n"
    printf "CORREO_USUARIO=''\n\n"
